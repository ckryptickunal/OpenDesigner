...
**Top findings**
1. **Two thirds of a design system is generatable; the designer-owned part is small but it is what people see first.** Of 207 ontology blocks (counted from ONTOLOGY.md on 23 Sep 2026; `ontology.json` now has 211 non-builder leaf blocks, and its own `provenance` tags classify them differently [S-V1b-091]), 135 are generatable from a few inputs and dials, 31 are tool-assisted, 29 are decisions only the owner can make, 7 are designer-owned and 5 are best read from existing assets; 44 can be pre-filled from a reference (Part G). The 7 designer-owned blocks expand into 14 asset hooks (Part H). The task's four classes needed a fifth, owner input, so business decisions are not misfiled as design work (DC-L17-01).
...
| **Survey baseline** | - | - | Team size (zeroheight 2026, n=147): 1-2 people 28%, 3-5 33%, 6-10 25%, more than 10 people 14% (10-15 6%, 16-20 4%, 20+ 4%) [S-V1b-048]; 61% under-resourced. NN/g: 2-5 typical. Value: designers 34% faster with an up-to-date system (Figma 2019); 8 developers 47% faster with Carbon (small sample) | 2026: resourcing 56%, prioritizing updates 35%, buy-in 31%, cross-team consistency 31%; 44% call their system unstable. 2022 (Sparkbox, n=219): tech or creative debt 43%, design-code parity 37%, adoption 36% | [S-L17-347] [S-L17-349] [S-L17-351] [S-L17-362] [S-L17-363] |
...
4. **Vendors admit a default look.** Google bans purple neon and Inter in its taste skill; Anthropic lists five clusters; tweakcn exists because shadcn sites look alike; NN/g found the same generic sans-serif, shadcn-and-Tailwind look across the 14 tools tested (outputs from 10 shown) [S-V1a-069] [S-L17-218] [S-L17-021] [S-L17-232] [S-L17-120].
...
- [L17 -> L11] Update the competitor table: Motiff is discontinued (export until 31 Oct 2026); Lovable removed Themes on 16 Mar 2026 and made design systems available on all paid plans on 19 Aug 2026 (npm-package wrapping stays Enterprise-only) [S-V1a-057]; Figma ships an official `figma-generate-library` skill [S-L17-229] [S-L17-234] [S-L17-210].
