...
| **tweakcn** | ~40 token inputs (hex or Tailwind names); an AI Generate tab (text or image) | Real shadcn components in 5 contexts | **Undo stack of 30 entries; edits within 500 ms coalesce**; checkpoints; share | Tailwind v3/v4 CSS; `npx shadcn add https://tweakcn.com/r/themes/<id>`; Figma via a third-party kit | Full control; the flat list of ~40 fields is the cost; WCAG AA checker | commits to 3 Sep 2026 | [S-L16-306] [S-L16-332] [S-L16-333] |
