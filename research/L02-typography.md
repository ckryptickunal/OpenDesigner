...
| Section heading | Title L 22/28 | Title 2 22/28, Title 3 20/25 | Subtitle 1 20/28 (React v9 shipped tokens; site says 20/26) [S-L02-065] [S-L02-066] | heading-03 20/28 | heading-lg 20/24 | medium 20/24 | title medium 20/1.625, subtitle 20/1.625 | heading M 22, S 20, XS 18 |
...
- **Fluent web Subtitle 1 resolved for React v9 (2026-09-25):** choose 20px/28px, semibold 600. Published `@fluentui/react-theme@9.2.2` depends on `@fluentui/tokens@1.0.0-alpha.24`; its `subtitle1` maps to `fontSizeBase500`, `fontWeightSemibold` and `lineHeightBase500`, whose values are 20px, 600 and 28px. The live design-site web table still says 20px/26px. Retain that disagreement; shipped code wins under GOVERNANCE.md for React v9 output. This does not establish which value an uninspected Figma kit uses. [S-L02-065] [S-L02-066]
