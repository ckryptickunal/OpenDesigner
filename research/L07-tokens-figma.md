...
| Extended collections | Enterprise multi-brand: extend a parent collection per brand, override values, inherit everything else. The extension cannot add variables or modes or change scope/description. Color and opacity count as one override. Chains are allowed (C extends B extends A) | **Enterprise, Full seat** | Announced 28 Oct 2025; article created 14 Nov 2025 | [S-L07-015] [S-L07-016] [S-L07-034] |
