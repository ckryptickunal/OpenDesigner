...
| S1 | Synthesis: ontology (S1a), questionnaire (S1b), levers + decision graph (S1c), builder spec (S1d) | `synthesis/*` | S1a done (271 nodes, 10 layers, 325/325 cards mapped); S1c done (8 dials, 13 look recipes); S1b running; S1d (OpenDesigner spec) waits for S1b, L17, L18 |
