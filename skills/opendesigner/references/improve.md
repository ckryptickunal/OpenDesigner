...
1. Record it: `engine.py feedback "<what happened, what you expected>" --kind gap|bug|confusing|idea [--area color] [--question Q-color-07]`. The engine appends it to `opendesigner/feedback.md` and prints a pre-filled issue link for github.com/ckryptickunal/OpenDesigner.
