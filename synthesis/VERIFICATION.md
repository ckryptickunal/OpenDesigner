...
- 8 corrections waited for F1, the session rewriting `README.md` and `docs/`. Session "U4a docs" applied them on 2026-09-24, and session "F1 fixes" finished rows 24b and 24c the same day. 2 wait for Kunal (rows 30 and 31); the third, the block classification in row 24c, was decided by the orchestrator.
...
| 24b | partly | docs/HOW-IT-WORKS.md:44-52; README.md:100; docs/SPEC.md:9, :235; docs/GLOSSARY.md:418; docs/RESEARCH.md:47 | Same 207 / five-class counts. Reword after row 24c is decided | S-V1b-091 | applied (U4a docs, 2026-09-24) in README.md, docs/HOW-IT-WORKS.md and docs/RESEARCH.md, and as a dated note in docs/SPEC.md:9, :235. Finished by session "F1 fixes" on 2026-09-24: README.md, docs/HOW-IT-WORKS.md and docs/RESEARCH.md give the five-class `ontology.json` counts (211 blocks: 156 generatable, 23 tool-assisted, 21 owner input, 9 designer-owned, 2 extractable); dated notes in synthesis/OPENDESIGNER-SPEC.md:7, :235 and docs/SPEC.md:9, :237 say `ontology.json` is canonical; the five class entries in synthesis/glossary.json (source: synthesis/glossary/shard-a.json) use the `ontology.json` counts, and docs/GLOSSARY.md was rebuilt |
| 24c | partly | L17 classification (207 blocks: 135/31/29/7/5, with owner input) vs `ontology.json` provenance (211: 156/30/23/2, no owner input); also synthesis/OPENDESIGNER-SPEC.md:7, :233 and synthesis/glossary.json | Choose which classification is canonical, then reconcile the counts everywhere | S-V1b-091 | decided by orchestrator 2026-09-24 (DECISIONS.md): ontology.json is canonical. Applied by session "F1 fixes" on 2026-09-24: `ontology.json` and ONTOLOGY.md have the fifth class `owner-input`, and 27 team-decision nodes moved to it from designer-owned (all 275 nodes: 208 generatable, 27 owner-input, 26 tool-assisted, 11 designer-owned, 3 extractable); OPENDESIGNER-SPEC.md and glossary.json reconciled as in row 24b |
