...
- 8 corrections wait for F1, the session rewriting `README.md` and `docs/`. 3 wait for Kunal.
...
| 4b | wrong | docs/SPEC.md:182 | Same fix as row 4 | S-V1a-022 | pending F1 |
| 5 | wrong | docs/SPONSORSHIP.md:17 | The repo is **public** (still 0 stars) | S-V1b-001 | pending F1 |
...
| 15b | partly | docs/FAQ.md:146 | Same: "about 40 token inputs" should say about 46 controls | S-V1a-067 | pending F1 |
...
| 16b | partly | docs/FAQ.md:152 | "NN/g's study of 10 AI design tools" should say "NN/g's evaluation of AI prototyping tools (14 tested)" | S-V1a-069 | pending F1 |
...
| 24b | partly | docs/HOW-IT-WORKS.md:44-52; README.md:100; docs/SPEC.md:9, :235; docs/GLOSSARY.md:418; docs/RESEARCH.md:47 | Same 207 / five-class counts. Reword after row 24c is decided | S-V1b-091 | pending F1 (after Kunal) |
| 24c | partly | L17 classification (207 blocks: 135/31/29/7/5, with owner input) vs `ontology.json` provenance (211: 156/30/23/2, no owner input); also synthesis/OPENDESIGNER-SPEC.md:7, :233 and synthesis/glossary.json | Choose which classification is canonical, then reconcile the counts everywhere | S-V1b-091 | pending Kunal |
...
| 27 | confirmed, update | docs/SPONSORSHIP.md:31, :50 | Add: the first GitHub Sponsors payout comes 60 days after the first sponsorship; Stripe Connect pays on the 22nd whatever the balance | S-V1b-057 | pending F1 |
| 28 | answered open item | docs/SPONSORSHIP.md:231 | Resolved: Stripe Connect has no minimum payout (Additional Terms 3.3) | S-V1b-057 | pending F1 |
| 29 | answered open item | docs/SPONSORSHIP.md:240 | Resolved: Cline's blog names solo developers as a target | S-V1b-063 | pending F1 |
