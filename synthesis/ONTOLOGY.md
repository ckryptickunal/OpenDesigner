...
- Default: One glyph of 1-3 filled shapes on a solid or gradient background, exported as Apple layers, Android foreground, background and monochrome layers, and PWA sizes (DC-L05-12); a symbol-only logo at 24-32px in the app bar, the full lockup on sign-in and marketing (DC-L05-13).
...
- Default: Acknowledge within 50 ms; no indicator under about 1 s; skeleton for page or region loads of 1-10 s; spinner for a module or item; percent-done progress beyond 10 s (DC-L13-01).
...
- Default: Material's three archetypes plus a full-page document template; one pane below 840dp, two panes from 840dp, three only at the largest sizes (DC-L03-18).
...
Computed by the build script over `synthesis/cards.json` (325 cards) and the 225 nodes above.

- Cards mapped to exactly one node: 276 of 325
- Unmapped cards: 49 (DC-L07-08, DC-L07-09, DC-L07-18, DC-L07-19, DC-L07-20, DC-L07-21, DC-L07-23, DC-L07-24, DC-L07-25, DC-L07-26, DC-L08-23, DC-L09-08, DC-L10-22, DC-L11-06, DC-L11-07, DC-L11-08, DC-L11-09, DC-L11-10, DC-L11-11, DC-L11-12, DC-L11-13, DC-L11-14, DC-L11-15, DC-L11-16, DC-L11-17, DC-L11-18, DC-L11-20, DC-L11-21, DC-L11-22, DC-L11-23, DC-L11-24, DC-L14-11, DC-L14-14, DC-L15-11, DC-L16-01, DC-L16-02, DC-L16-03, DC-L16-04, DC-L16-05, DC-L16-06, DC-L16-07, DC-L16-08, DC-L16-09, DC-L16-10, DC-L16-11, DC-L16-12, DC-L16-13, DC-L16-14, DC-L16-15)
- Double-mapped cards: 0
- Nodes per layer: ctx 15, prin 18, found 123, tok 19, comp 27, pat 23, guard 0, deliver 0, gov 0, builder 0; total 225
