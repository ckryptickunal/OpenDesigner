...
## D-0005 · answers.Q-scope-06 = ["Application form:operate", "Guidance pages:read"]
- set_by: chosen · locked: no · date: 2026-09-24 · supersedes: none · source_ref: none
- reason: surfaces
- also set: context.surfaces = [{"name": "Application form", "mode": "Operate"}, {"name": "Guidance pages", "mode": "Read"}] (from Q-scope-06)
