...
EXAMPLES = {
    "devtool-dense": {
        ...
        "steps": [
            ...
            ("pick", "Q-scope-06", ["Pipelines table:operate", "Run detail and logs:read"], "two main surfaces, the table first"),
    ...
    "consumer-playful": {
        ...
        "steps": [
            ...
            ("pick", "Q-scope-06", ["Today feed:experience", "Onboarding and store pages:persuade", "Settings:operate"], "surfaces and their modes"),
    ...
    "public-service-accessible": {
        ...
        "steps": [
            ...
            ("pick", "Q-scope-06", ["Application form:operate", "Guidance pages:read"], "surfaces"),
