...
## D-0005 · answers.Q-scope-06 = ["Pipelines table:operate", "Run detail and logs:read"]
- set_by: chosen · locked: no · date: 2026-09-24 · supersedes: none · source_ref: none
- reason: two main surfaces, the table first
- also set: context.surfaces = [{"name": "Pipelines table", "mode": "Operate"}, {"name": "Run detail and logs", "mode": "Read"}] (from Q-scope-06)
- also set: raw.productType = "work-tool" (from Q-scope-06)
- also set: raw.marketingSurfaces = false (from Q-scope-06)
